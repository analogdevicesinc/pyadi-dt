...
def test_profile_manager_loads_ad9081_zc706_profile():
    profile = ProfileManager().load("ad9081_zc706")
    assert profile["name"] == "ad9081_zc706"
    assert profile["defaults"]["clock"]["hmc7044_rx_channel"] == 10
    assert profile["defaults"]["clock"]["hmc7044_tx_channel"] == 6
    assert profile["defaults"]["ad9081_board"]["clock_spi"] == "spi1"
    assert profile["defaults"]["ad9081_board"]["adc_spi"] == "spi0"
...
def test_profile_manager_loads_ad9172_profile():
    profile = ProfileManager().load("ad9172_zcu102")
...
def test_profile_manager_loads_adrv9009_zc706_profile():
    profile = ProfileManager().load("adrv9009_zc706")
    assert profile["name"] == "adrv9009_zc706"
    assert profile["defaults"]["adrv9009_board"]["spi_bus"] == "spi0"
    assert profile["defaults"]["adrv9009_board"]["clk_cs"] == 0
    assert profile["defaults"]["adrv9009_board"]["trx_cs"] == 1
...
def test_profile_manager_loads_adrv9025_profile():
    profile = ProfileManager().load("adrv9025_zcu102")
    assert profile["name"] == "adrv9025_zcu102"
    assert profile["defaults"]["adrv9009_board"]["spi_bus"] == "spi0"
    assert profile["defaults"]["adrv9009_board"]["clk_cs"] == 0
    assert profile["defaults"]["adrv9009_board"]["trx_cs"] == 1


def test_profile_manager_loads_adrv937x_profile():
    profile = ProfileManager().load("adrv937x_zcu102")
    assert profile["name"] == "adrv937x_zcu102"
    assert profile["defaults"]["adrv9009_board"]["spi_bus"] == "spi0"
    assert profile["defaults"]["adrv9009_board"]["clk_cs"] == 0
    assert profile["defaults"]["adrv9009_board"]["trx_cs"] == 1


def test_profile_manager_loads_adrv937x_zc706_profile():
    profile = ProfileManager().load("adrv937x_zc706")
    assert profile["name"] == "adrv937x_zc706"
    assert profile["defaults"]["adrv9009_board"]["spi_bus"] == "spi0"
    assert profile["defaults"]["adrv9009_board"]["clk_cs"] == 0
    assert profile["defaults"]["adrv9009_board"]["trx_cs"] == 1
