"""ADRV9025 + ZCU102: full XSA -> DTS generation example.

This example adds a runnable flow for Kuiper project
``zynqmp-zcu102-rev10-adrv9025``.
...
DEFAULT_OUT_DIR = HERE / "output_adrv9025_zcu102"
DEFAULT_KUIPER_RELEASE = "2023_r2"
DEFAULT_KUIPER_PROJECT = "zynqmp-zcu102-rev10-adrv9025"


def _default_config() -> dict:
    # Reuse ADRV9009-style defaults for the current shared ADRV90xx node path.
    return {
        "jesd": {
