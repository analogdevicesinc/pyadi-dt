"""AD9082 + ZCU102: full XSA -> DTS generation example.

This flow uses explicit profile selection:

    profile="ad9082_zcu102"

Rationale: AD9081/AD9082 ZCU102 XSAs frequently use shared ``mxfe`` JESD
instance naming, so topology-only auto-inference cannot reliably distinguish
them.
...
DEFAULT_OUT_DIR = HERE / "output_ad9082_zcu102"
DEFAULT_KUIPER_RELEASE = "2023_r2"
DEFAULT_KUIPER_PROJECT = "zynqmp-zcu102-rev10-ad9082-m4-l8"
...
def main() -> None:
    ...
    print("Generated artifacts (explicit profile=ad9082_zcu102):")
