"""FMCDAQ3 + ZCU102: XSA -> DTS generation example (explicit profile)."""
...
DEFAULT_OUT_DIR = HERE / "output_fmcdaq3_zcu102"
...
def main() -> None:
    ...
    result = XsaPipeline().run(
        ...
        cfg=_default_config(),
        output_dir=out_dir,
        profile="fmcdaq3_zcu102",
    )
    print("Generated artifacts (explicit profile=fmcdaq3_zcu102):")
