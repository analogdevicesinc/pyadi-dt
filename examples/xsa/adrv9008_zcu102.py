"""ADRV9008 + ZCU102: full XSA -> DTS generation example.

This follows the same flow as the ADRV9009 example, but uses an explicit
profile selection:

    profile="adrv9008_zcu102"

Rationale: many ADRV9008 Kuiper XSAs use ADRV9009-style JESD/core labels,
so auto-profile inference from topology alone is ambiguous.
...
DEFAULT_OUT_DIR = HERE / "output_adrv9008_zcu102"
DEFAULT_KUIPER_RELEASE = "2023_r2"
DEFAULT_KUIPER_PROJECT = "zynqmp-zcu102-rev10-adrv9008-1-2"


def _default_config() -> dict:
    # Use the shared ADRV90xx JESD defaults; board wiring comes from profile.
    return {
        "jesd": {
...
def main() -> None:
    ...
    print("Generated artifacts (explicit profile=adrv9008_zcu102):")
