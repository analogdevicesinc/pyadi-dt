"""AD9172 + ZCU102: XSA -> DTS generation example (explicit profile).

This flow uses explicit profile selection:

    profile="ad9172_zcu102"

Note: AD9172 and AD9528 are SPI devices and are not directly represented as
dedicated converter IP blocks in XSA. This example currently demonstrates
pipeline generation + profile application for the JESD/clock topology.
...
DEFAULT_OUT_DIR = HERE / "output_ad9172_zcu102"
...
def _default_config() -> dict:
    return {
        "clock": {
            ...
            "tx_jesd_input_label": "dac_jesd204_xcvr",
            "tx_jesd_input_link_id": 0,
        }
    }
...
def main() -> None:
    ...
    print("Generated artifacts (explicit profile=ad9172_zcu102):")
