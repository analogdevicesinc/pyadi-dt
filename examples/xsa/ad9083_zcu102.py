"""AD9083 + ZCU102: full XSA -> DTS generation example.

This flow uses explicit profile selection:

    profile="ad9083_zcu102"

Rationale: AD908x ZCU102 XSAs frequently use shared ``mxfe`` JESD instance
naming, so topology-only auto-inference cannot reliably distinguish AD9081,
AD9082, and AD9083.
...
DEFAULT_OUT_DIR = HERE / "output_ad9083_zcu102"
DEFAULT_KUIPER_RELEASE = "2023_r2"
DEFAULT_KUIPER_PROJECT = "zynqmp-zcu102-rev10-ad9083-fmc-ebz"


def _default_config() -> dict:
    return {
        "jesd": {
            "rx": {"F": 4, "K": 32, "M": 4, "L": 8, "Np": 16, "S": 1},
            "tx": {"F": 4, "K": 32, "M": 4, "L": 8, "Np": 16, "S": 1},
        },
        "clock": {
...
def main() -> None:
    ...
    print("Generated artifacts (explicit profile=ad9083_zcu102):")
