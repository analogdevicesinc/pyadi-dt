"""FMCDAQ3 + ZC706: XSA -> DTS generation example (explicit profile)."""
...
DEFAULT_OUT_DIR = HERE / "output_fmcdaq3_zc706"
...
def main() -> None:
    ...
    result = XsaPipeline().run(
        ...
        cfg={},
        output_dir=out_dir,
        profile="fmcdaq3_zc706",
    )
    print("Generated artifacts (explicit profile=fmcdaq3_zc706):")
