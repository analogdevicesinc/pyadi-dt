"""ADRV9002 + ZC706: XSA -> DTS generation example (explicit profile)."""
...
DEFAULT_OUT_DIR = HERE / "output_adrv9002_zc706"
DEFAULT_KUIPER_RELEASE = "2023_r2"
DEFAULT_KUIPER_PROJECT = "zynq-zc706-adv7511-adrv9002"
...
def main() -> None:
    ...
    result = XsaPipeline().run(
        ...
        cfg={},
        output_dir=out_dir,
        profile="adrv9002_zc706",
    )
    print("Generated artifacts (explicit profile=adrv9002_zc706):")
