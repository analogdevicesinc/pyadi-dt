...
def parse_talise_config_c(file):
    ...
    tree = StructTree(
        ...
        children=[
                    ...
                    StructTree(
                        ...
                        children=[
                            ...
                            StructTree(
                                name="rxAdcProfile",
                                type="array",
                                pattern=".rxAdcProfile =",
                            ),
                            StructTree(
                                name="rxNcoShifterCfg", pattern=".rxNcoShifterCfg ="
                            ),
                        ],
                    ),
                ...
                children=[
                    StructTree(
                        ...
                        children=[
                            ...
                            StructTree(
                                name="loopBackAdcProfile",
                                pattern=".loopBackAdcProfile =",
                                type="array",
                            ),
                        ],
                    ),
            ...
            StructTree(
                name="jesd204Settings",
                pattern=".jesd204Settings =",
                children=[
