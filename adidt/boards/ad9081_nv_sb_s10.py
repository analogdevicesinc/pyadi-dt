...
class ad9081_nv_sb_s10(layout):
    """AD9081 Nvidia Sensor Bridge + AD9081-FMC board layout map for clocks and DSP"""
    ...
    def map_clocks_to_board_layout(self, cfg):
        ...
        map["DEV_SYSREF"] = {
            "source_port": 3,
            "divider": np.max(
                [clk["AD9081_ref_clk"]["divider"], clk["dac_sysref"]["divider"]]
            ),
        }
        map["FPGA_SYSREF"] = {
            "source_port": 13,
        ...
        map["CORE_CLK_RX"] = {
            "source_port": 0,
            "divider": clk["nvsbs10_adc_device_clk"]["divider"],
        }
        map["CORE_CLK_RX_ALT"] = {
            "source_port": 10,
            "divider": clk["nvsbs10_adc_device_clk"]["divider"] * 1,
        }
        map["FPGA_REFCLK1"] = {
            "source_port": 8,
            "divider": clk["nvsbs10_adc_ref_clk"]["divider"],
        }

        # Tx side
        map["CORE_CLK_TX"] = {
            "source_port": 6,
            "divider": clk["nvsbs10_dac_device_clk"]["divider"],
        }
        map["FPGA_REFCLK2"] = {
            "source_port": 12,
            "divider": clk["nvsbs10_dac_ref_clk"]["divider"],
        }
