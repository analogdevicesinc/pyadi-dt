...
_ADRV9009_BOARD_ALLOWED_KEYS = {
    ...
    # HMC7044 / dual-transceiver (FMComms8, ADRV9009-ZU11EG SoM) keys
    "hmc7044_vcxo_frequency",
    "hmc7044_pll2_output_frequency",
    "hmc7044_rx_channel",
    "hmc7044_tx_channel",
    "hmc7044_xcvr_channel",
    "hmc7044_tx_xcvr_channel",
    "hmc7044_trx0_dev_channel",
    "hmc7044_trx0_sysref_dev_channel",
    "hmc7044_trx0_sysref_fmc_channel",
    "hmc7044_trx1_dev_channel",
    "hmc7044_trx1_sysref_dev_channel",
...
_ADRV9009_BOARD_INT_KEYS = {
    ...
    "tx_octets_per_frame",
    "rx_os_octets_per_frame",
    # HMC7044 / dual-transceiver numeric keys
    "hmc7044_vcxo_frequency",
    "hmc7044_pll2_output_frequency",
    "hmc7044_rx_channel",
    "hmc7044_tx_channel",
