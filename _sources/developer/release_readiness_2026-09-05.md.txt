...
Final validated candidate: `c4e9a605f540dcf6d0f7882627a82765b4207e94` (version
`0.0.1`, baseline `ee5d7b9`). See the [validation summary](hardware_validation.md)
for final hardware and hosted results. Earlier stages are retained below as history.
...
- Initial full Python 3.12 suite: **917 passed, 14 skipped, no expected failures**;
...
## Initial hardware evidence (superseded by final qualification)

The table below records the earlier investigation stage. In particular, its
ZU11EG deployment gap was closed by the final generated-tree test documented in
[the validation summary](hardware_validation.md).
...
| `tron` / ADRV9009-ZU11EG | XSA pipeline and DTB compilation passed. After reconnecting JTAG, the stock SD image boots through production U-Boot: both PHYs initialize, all three JESD links report DATA, and local DMA captures 65,536 bytes. | This earlier stage predates the final generated-DTB qualification; see the validation summary for the completed serial-DTB transfer and CRC checks. |
